...
int main()
{
	...
	system("sudo cp /usr/share/archiso/config/releng/packages.both /root/archisoconfig");
	system("sudo cp /usr/share/archiso/config/releng/packages.x86_64 /root/archisoconfig");
	system("sudo cp /usr/share/archiso/config/releng/packages.i686 /root/archisoconfig");
	system("sudo cp /usr/share/archiso/config/releng/pacman.conf");
	system("sudo mkdir /root/archisoconfig/airootfs/home");
	system("sudo mkdir /root/archisoconfig/airootfs/root");
	system("sudo cp /usr/share/archiso/config/releng/airootfs/root/customize_airootfs.sh /root/archisoconfig/airootfs/root/customize_airootfs.sh");
